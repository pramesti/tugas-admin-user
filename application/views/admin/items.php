      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">Item List</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> Detail item </p>
                </div>
                <div class="card-body">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <img height="200" src="<?= base_url('assets/images/'.$it->nama_kategori.'/'.$it->gambar_barang) ?>" alt="<?= $it->nama_barang ?>">
                          </td>
                          <td>
                            <?= $it->stok ?>
                          </td>
                          <td>
                            <a href="<?= base_url('admin/edititem/'.$it->id_barang) ?>">
                              <i class="material-icons">edit</i>
                            </a>  
                            <a href="<?= base_url('admin/deleteitem/'.$it->id_barang) ?>">
