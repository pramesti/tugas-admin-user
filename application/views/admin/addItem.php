      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">Add Item</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> Form add item </p>
                </div>
                <div class="card-body">
                <form method="post" action="<?= base_url('admin/saveItem') ?>" enctype="multipart/form-data">
                    <div class="row">
                      ...
                      <div class="col-md-4 mt-3">
                        <div class="form-group">
                          <label>Harga</label>
                          <input type="number" id="harga" min="0" name="harga" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-4 mt-3">
                        <div class="form-group">
                          <label>Stok</label>
                          <input type="number" id="stok" min="0" name="stok" class="form-control">
                        </div>
                      </div>
                    ...
                    <button type="submit" class="btn btn-primary pull-right mt-3">Tambahkan</button>
                  </form>
                </div>
              </div>
            </div>
