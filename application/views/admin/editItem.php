      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo">Edit Item</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> Form edit item </p>
                </div>
                <div class="card-body">
                <form method="post" action="<?= base_url('admin/updateItem/'.$item->id_barang) ?>" enctype="multipart/form-data">
                    <div class="row">
                      ...
                      <div class="col-md-4 mt-3">
                        <div class="form-group">
                          ...
                          <input value="<?= $item->nama_barang ?>" type="text" name="nama" id="nama" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-4 mt-3">
                        <div class="form-group">
                          <label>Harga</label>
                          <input type="number" value="<?= $item->harga ?>" id="harga" min="0" name="harga" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-4 mt-3">
                        <div class="form-group">
                          <label>Stok</label>
                          <input type="number" id="stok" min="0" value="<?= $item->stok ?>" name="stok" class="form-control">
                        </div>
                      </div>
                      ...
                      <div class="col-md-4 mt-3">
                        <label>Gambar</label>
                        <input type="file" value="<?= base_url('assets/images/'.$item->nama_kategori.'/'.$item->gambar_barang) ?>" id="gambar" name="gambar" class="form-control mt-3">
                      </div>
                    </div>
